...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'auth.guards.token.driver' => 'string',
            'auth.guards.token.provider' => 'string',
            'auth.providers.users.driver' => 'string',
            'auth.providers.users.model' => 'string',
            'auth.providers.tokens.driver' => 'string',
            'auth.providers.tokens.model' => 'string',
            ...
            'filament-one-time-operations.operation_resource.cluster' => 'NULL',
            'filament-one-time-operations.operation_resource.model' => 'string',
            'filament-one-time-operations.operation_resource.should_register_navigation' => 'boolean',
            'filament-one-time-operations.operation_resource.navigation_badge' => 'boolean',
            'filament-one-time-operations.operation_resource.navigation_sort' => 'integer',
            'filament-one-time-operations.operation_resource.slug' => 'string',
            ...
            'filesystems.links.D:\jsgtecnologia\2025-06-composer.jsg.tec.br\public\storage' => 'string',
...
'admin.password','app.name','app.env','app.debug','app.url',
...
'auth.guards.web.provider','auth.guards.token.driver','auth.guards.token.provider','auth.providers.users.driver','auth.providers.users.model',
'auth.providers.tokens.driver','auth.providers.tokens.model','auth.passwords.users.provider','auth.passwords.users.table','auth.passwords.users.expire',
'auth.passwords.users.throttle','auth.password_timeout','blade-icons.sets.default.path','blade-icons.sets.default.disk','blade-icons.sets.default.prefix',
'blade-icons.sets.default.fallback','blade-icons.sets.default.class','blade-icons.sets.default.attributes','blade-icons.class','blade-icons.attributes',
'blade-icons.fallback','blade-icons.components.disabled','blade-icons.components.default','cache.default','cache.stores.array.driver',
...
'database.redis.cache.database','filakit.theme_mode','filakit.admin_panel_enabled','filakit.favicon.enabled','filakit.favicon.manifest.name',
'filakit.favicon.logo','filakit.favicon.favicon','filament-one-time-operations.operation_resource.cluster','filament-one-time-operations.operation_resource.model','filament-one-time-operations.operation_resource.should_register_navigation',
'filament-one-time-operations.operation_resource.navigation_badge','filament-one-time-operations.operation_resource.navigation_sort','filament-one-time-operations.operation_resource.slug','filesystems.default','filesystems.disks.local.driver',
...
'filesystems.links.D:\\jsgtecnologia\\2025-06-composer.jsg.tec.br\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'blade-heroicons.fallback','blade-heroicons.class','blade-heroicons.attributes','filament.broadcasting','filament.default_filesystem_disk',
...
'livewire.inject_morph_markers','livewire.pagination_theme','blade-tabler-icons.prefix','blade-tabler-icons.fallback','blade-tabler-icons.class',
'blade-tabler-icons.attributes','one-time-operations.directory','one-time-operations.table','one-time-operations.connection','ide-helper.filename',
...
'filament.admin.auth.profile','filament.admin.pages.dashboard','filament.admin.resources.dependencies.index','filament.admin.resources.dependencies.view','filament.admin.resources.package-releases.index',
'filament.admin.resources.package-releases.view','filament.admin.resources.packages.index','filament.admin.resources.packages.create','filament.admin.resources.packages.view','filament.admin.resources.packages.edit',
'filament.admin.resources.tokens.index','filament.admin.resources.tokens.create','filament.admin.resources.tokens.view','filament.admin.resources.tokens.edit','filament.admin.resources.users.index',
'filament.admin.resources.users.create','filament.admin.resources.users.view','filament.admin.resources.users.edit','filament.admin.resources.settings.operation.index','filament.admin.resources.settings.operation.view',
...
'filament-infolists::components.tabs.tab','filament-infolists::components.text-entry','filament-logo::logo-before','filament-logo::logo-start','filament-logo::styles',
...
'filament-panels::resources.pages.view-record','filament-panels::resources.relation-manager','filament-panels::widgets.account-widget','filament-panels::widgets.filament-info-widget','filament-table-select::selection-table-handler',
'filament-table-select::selection-table-handler','filament-table-select::selection-table-modal','filament-table-select::selection-table-modal','filament-table-select::table-select','filament-table-select::table-select',
...
'dependencies.label','dependencies.plural','dependencies.navigation.label','dependencies.navigation.group','dependencies.dependency_type.private',
'dependencies.dependency_type.public','dependencies.infolist.name','dependencies.infolist.type','dependencies.infolist.versions','dependencies.infolist.section.package_releases',
'dependencies.table.name','dependencies.table.type','dependencies.table.versions','dependencies.table.package_releases_count','dependencies.table.created_at',
'dependencies.table.updated_at','navigation.tenants','navigation.plans','navigation.website','navigation.support',
'navigation.settings','navigation.register','navigation.schedule','navigation.package','navigation.package_info',
'package_downloads.label','package_downloads.plural','package_downloads.navigation.label','package_downloads.navigation.group','package_downloads.infolist.package.name',
'package_downloads.infolist.version','package_downloads.infolist.downloads','package_downloads.table.package.name','package_downloads.table.version','package_downloads.table.downloads',
'package_downloads.table.created_at','package_downloads.table.updated_at','package_releases.label','package_releases.plural','package_releases.navigation.label',
'package_releases.navigation.group','package_releases.infolist.package.name','package_releases.infolist.version','package_releases.infolist.time','package_releases.infolist.type',
'package_releases.infolist.description','package_releases.infolist.homepage','package_releases.infolist.section.dependencies','package_releases.table.package.name','package_releases.table.version',
'package_releases.table.dependencies_count','package_releases.table.time','package_releases.table.type','package_releases.table.description','package_releases.table.homepage',
'package_releases.table.created_at','package_releases.table.updated_at','packages.label','packages.plural','packages.navigation.label',
'packages.navigation.group','packages.form.url.composer','packages.form.url.github','packages.form.username.composer','packages.form.username.github',
'packages.form.password.composer','packages.form.password.github','packages.instructions.composer.label','packages.instructions.composer.content','packages.instructions.github.label',
'packages.instructions.github.content','packages.validations.name.composer','packages.validations.name.github','packages.validations.url.github','packages.validations.password.github',
'packages.infolist.name','packages.infolist.type','packages.infolist.url','packages.infolist.section.package_releases','packages.infolist.section.package_release',
'packages.infolist.section.dependencies','packages.table.name','packages.table.package_releases_count','packages.table.type','packages.table.url',
'packages.table.created_at','packages.table.updated_at','tokens.label','tokens.plural','tokens.navigation.label',
'tokens.navigation.group','tokens.form.name','tokens.form.packages','tokens.copy_message.token','tokens.copy_message.composer_command',
'tokens.copy_message.composer_repository','tokens.infolist.name','tokens.infolist.token','tokens.infolist.composer_command','tokens.infolist.composer_repository',
'tokens.infolist.section.packages','tokens.table.name','tokens.table.packages_count','tokens.table.created_at','tokens.table.updated_at',
'es.0','pt_BR.0','filament-table-select::table-select.placeholder','filament-table-select::table-select.actions.selection.view-label','filament-table-select::table-select.actions.selection.edit-label',
'filament-table-select::table-select.actions.selection-confirmation.label','filament-table-select::table-select.actions.selection-create-option.label','filament-actions::associate.single.label','filament-actions::associate.single.modal.heading','filament-actions::associate.single.modal.fields.record_id.label',
...
'filament-tables::table.sorting.fields.direction.label','filament-tables::table.sorting.fields.direction.options.asc','filament-tables::table.sorting.fields.direction.options.desc','filament-one-time-operations::filament-one-time-operations.column.name','filament-one-time-operations::filament-one-time-operations.column.dispatched',
'filament-one-time-operations::filament-one-time-operations.column.processed_at','filament-one-time-operations::filament-one-time-operations.infolist.name','filament-one-time-operations::filament-one-time-operations.infolist.dispatched','filament-one-time-operations::filament-one-time-operations.infolist.processed_at','filament-one-time-operations::filament-one-time-operations.values.async',
'filament-one-time-operations::filament-one-time-operations.values.sync','filament-one-time-operations::filament-one-time-operations.tabs.all','filament-one-time-operations::filament-one-time-operations.tabs.async','filament-one-time-operations::filament-one-time-operations.tabs.sync','filament-one-time-operations::filament-one-time-operations.nav.group',
'filament-one-time-operations::filament-one-time-operations.nav.operation.label','filament-one-time-operations::filament-one-time-operations.nav.operation.icon','filament-one-time-operations::filament-one-time-operations.resource.label.operation','filament-one-time-operations::filament-one-time-operations.resource.label.operations',);
