...
'database.redis.cache.port','database.redis.cache.database','filakit.theme_mode','filakit.admin_panel_enabled','filakit.favicon.enabled',
'filakit.favicon.manifest.name','filakit.favicon.logo','filakit.favicon.favicon','filament-one-time-operations.operation_resource.cluster','filament-one-time-operations.operation_resource.model',
'filament-one-time-operations.operation_resource.should_register_navigation','filament-one-time-operations.operation_resource.navigation_badge','filament-one-time-operations.operation_resource.navigation_sort','filament-one-time-operations.operation_resource.slug','filesystems.default',
...
'filesystems.disks.s3.report','filesystems.links.D:\\jsgtecnologia\\2025-06-composer.jsg.tec.br\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'blade-heroicons.prefix','blade-heroicons.fallback','blade-heroicons.class','blade-heroicons.attributes','filament.broadcasting',
...
'livewire.navigate.progress_bar_color','livewire.inject_morph_markers','livewire.pagination_theme','one-time-operations.directory','one-time-operations.table',
'one-time-operations.connection','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename','ide-helper.include_fluent',
