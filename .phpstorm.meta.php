...
'filament-infolists::components.tabs.tab','filament-infolists::components.text-entry','filament-language-switch::components.flag','filament-language-switch::language-switch','filament-language-switch::switch',
'filament-logo::logo-before','filament-logo::logo-start','filament-logo::styles','filament-notifications::components.actions','filament-notifications::components.body',
...
'packages.infolist.section.package_release','packages.infolist.section.dependencies','packages.copy_message.composer_command','packages.table.name','packages.table.package_releases_count',
'packages.table.type','packages.table.url','packages.table.created_at','packages.table.updated_at','tokens.label',
'tokens.plural','tokens.navigation.label','tokens.navigation.group','tokens.form.name','tokens.form.packages',
'tokens.copy_message.token','tokens.copy_message.composer_command','tokens.copy_message.composer_repository','tokens.infolist.name','tokens.infolist.token',
'tokens.infolist.composer_command','tokens.infolist.composer_repository','tokens.infolist.section.packages','tokens.table.name','tokens.table.packages_count',
'tokens.table.created_at','tokens.table.updated_at','es.0','pt_BR.0','filament-actions::associate.single.label',
...
'filament-one-time-operations::filament-one-time-operations.column.name','filament-one-time-operations::filament-one-time-operations.column.dispatched','filament-one-time-operations::filament-one-time-operations.column.processed_at','filament-one-time-operations::filament-one-time-operations.infolist.name','filament-one-time-operations::filament-one-time-operations.infolist.dispatched',
'filament-one-time-operations::filament-one-time-operations.infolist.processed_at','filament-one-time-operations::filament-one-time-operations.values.async','filament-one-time-operations::filament-one-time-operations.values.sync','filament-one-time-operations::filament-one-time-operations.tabs.all','filament-one-time-operations::filament-one-time-operations.tabs.async',
'filament-one-time-operations::filament-one-time-operations.tabs.sync','filament-one-time-operations::filament-one-time-operations.nav.group','filament-one-time-operations::filament-one-time-operations.nav.operation.label','filament-one-time-operations::filament-one-time-operations.nav.operation.icon','filament-one-time-operations::filament-one-time-operations.resource.label.operation',
'filament-one-time-operations::filament-one-time-operations.resource.label.operations',);
